...
describe("SorteoClass", () => {
    ...
    it("should not register a participant with the same email", () => {
        sorteo.registrarParticipante("John Doe", "john.doe@example.com", "123456789");
        expect(() => sorteo.registrarParticipante("Jane Doe", "john.doe@example.com", "987654321")).toThrow("Ya existe un participante con el mismo email.");
    });
    it("should reserve a number", () => {
        ...
        expect((_a = state.reservadoPor) === null || _a === void 0 ? void 0 : _a.name).toBe("John Doe");
    });
    it("should not reserve a taken number", () => {
        sorteo.registrarParticipante("John Doe", "john.doe@example.com", "123456789");
        sorteo.reservarNumero(10, "john.doe@example.com");
        sorteo.registrarParticipante("Jane Doe", "jane.doe@example.com", "987654321");
        expect(() => sorteo.reservarNumero(10, "jane.doe@example.com")).toThrow("El número ya está reservado.");
    });
    ...
    it("should draw a winner", () => {
        ...
        expect(winner === null || winner === void 0 ? void 0 : winner.participante.name).toBe("John Doe");
    });
